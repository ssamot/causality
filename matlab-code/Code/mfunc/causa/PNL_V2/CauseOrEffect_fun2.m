function [thresh_1,testS_1,thresh_2,testS_2,fx_1,gy_1,e_1,fx_2,gy_2,e_2,pval_1,pval_2] =...
    CauseOrEffect_fun2(x, alpha)
...
% if we have too many data points, just randomly draw 5000 points for
% learning
if T>5000
    I_tmp = randperm(T);
    x1 = x1(I_tmp(1:5000));
...
fprintf('For the direction x1->x2...\n');
% to test if x1 -> x2
[thresh_1,testS_1,pval_1,params] = hsicTestGamma_new(e_1',x',alpha,params);
% to test if x2 -> x1
fprintf('For the direction x2->x1...\n');
[thresh_2,testS_2,pval_2,params] = hsicTestGamma_new(e_2',y',alpha,params);
