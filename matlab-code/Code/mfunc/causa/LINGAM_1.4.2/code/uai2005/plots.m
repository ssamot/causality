function plots
% plots - produces the plots for our UAI-2005 paper
%
% SYNTAX:
% plots;
%
% What?
% Similar to test.m, but runs a number of tests and produces the
% figure for our paper submitted to UAI-2005. 
%
